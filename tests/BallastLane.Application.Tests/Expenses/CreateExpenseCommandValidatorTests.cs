...
public class CreateExpenseCommandValidatorTests
{
    ...
    private readonly CreateExpenseCommandValidator _sut = new();

    private static CreateExpenseCommand Valid(
        decimal? amount = null,
    ...
    public void Non_positive_amount_fails(decimal amount)
    {
        ...
        result.Errors.ShouldContain(e => e.PropertyName == nameof(CreateExpenseCommand.Amount));
    }
    ...
    public void Description_exceeding_500_chars_fails()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.PropertyName == nameof(CreateExpenseCommand.Description));
    }

    [Fact]
    public void Null_description_passes()
    {
        ValidationResult result = _sut.Validate(Valid(description: null));
    ...
    [InlineData("Other")]
    public void Valid_category_names_pass_case_insensitive(string category)
    {
        ValidationResult result = _sut.Validate(Valid(category: category));
    ...
    public void Default_incurred_at_fails()
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors.ShouldContain(e => e.PropertyName == nameof(CreateExpenseCommand.IncurredAt));
    }
}
